...
import ru.pixnews.features.featuretoggles.FeatureTogglePreviewFixtures
import ru.pixnews.features.featuretoggles.FeatureTogglePreviewParameterProvider
    ...
    Row(modifier = modifier) {
        ...
        if (toggle.isOverridden) {
            TextButton(
                ...
                Icon(
                    imageVector = PixnewsIcons.CancelIcon,
