 ...
 */
package ru.pixnews.library.igdb.internal.webhook
...
internal object IgdbWebhookListJsonParser : (InputStream) -> List<IgdbWebhook> {
    override fun invoke(inputStream: InputStream): List<IgdbWebhook> {
