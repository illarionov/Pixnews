...
internal val PersonRoundedUnfilled400w0g24dp: ImageVector
    get() = cache ?: ImageVector.Builder(
        name = "PersonRoundedUnfilled400w0g24dp",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        lineTo(720.0f, 688.0f)
        quadTo(720.0f, 677.0f, 714.5f, 668.0f)
        quadTo(709.0f, 659.0f, 700.0f, 654.0f)
        quadTo(646.0f, 627.0f, 591.0f, 613.5f)
        quadTo(536.0f, 600.0f, 480.0f, 600.0f)
        quadTo(424.0f, 600.0f, 369.0f, 613.5f)
        quadTo(314.0f, 627.0f, 260.0f, 654.0f)
        quadTo(251.0f, 659.0f, 245.5f, 668.0f)
        quadTo(240.0f, 677.0f, 240.0f, 688.0f)
        lineTo(240.0f, 720.0f)
        close()
        moveTo(480.0f, 400.0f)
        quadTo(513.0f, 400.0f, 536.5f, 376.5f)
        quadTo(560.0f, 353.0f, 560.0f, 320.0f)
        quadTo(560.0f, 287.0f, 536.5f, 263.5f)
        quadTo(513.0f, 240.0f, 480.0f, 240.0f)
        quadTo(447.0f, 240.0f, 423.5f, 263.5f)
        quadTo(400.0f, 287.0f, 400.0f, 320.0f)
        quadTo(400.0f, 353.0f, 423.5f, 376.5f)
        quadTo(447.0f, 400.0f, 480.0f, 400.0f)
        close()
        moveTo(480.0f, 320.0f)
        quadTo(480.0f, 320.0f, 480.0f, 320.0f)
        quadTo(480.0f, 320.0f, 480.0f, 320.0f)
        quadTo(480.0f, 320.0f, 480.0f, 320.0f)
        quadTo(480.0f, 320.0f, 480.0f, 320.0f)
        quadTo(480.0f, 320.0f, 480.0f, 320.0f)
        ...
        quadTo(480.0f, 720.0f, 480.0f, 720.0f)
        quadTo(480.0f, 720.0f, 480.0f, 720.0f)
        quadTo(480.0f, 720.0f, 480.0f, 720.0f)
        quadTo(480.0f, 720.0f, 480.0f, 720.0f)
        quadTo(480.0f, 720.0f, 480.0f, 720.0f)
