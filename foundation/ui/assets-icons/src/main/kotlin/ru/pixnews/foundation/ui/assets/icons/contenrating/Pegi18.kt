...
internal val Pegi18: ImageVector
    get() = cache ?: ImageVector.Builder(
        ...
        path(
            fill = SolidColor(Color(0xffe2011a)),
            fillAlpha = 1.0f,
            stroke = null,
            strokeAlpha = 1f,
            strokeLineWidth = 1f,
        ...
        path(
            ...
            moveTo(41.55f, 101.27f)
            horizontalLineTo(23.14f)
            verticalLineTo(37.29f)
            horizontalLineTo(11.1f)
            verticalLineTo(26.43f)
            curveTo(19.36f, 26.55f, 24.79f, 23.13f, 27.74f, 15.1f)
            horizontalLineTo(41.55f)
            verticalLineTo(101.27f)
            close()
        }
        path(
            fill = SolidColor(Color(0xffffffff)),
            ...
            moveTo(58.55f, 76.72f)
            curveTo(58.55f, 68.22f, 60.44f, 62.2f, 67.4f, 56.89f)
            curveTo(61.61f, 51.1f, 59.49f, 46.03f, 59.49f, 38.24f)
            curveTo(59.49f, 24.66f, 68.11f, 15.1f, 82.27f, 15.1f)
            curveTo(96.44f, 15.1f, 105.05f, 24.66f, 105.05f, 38.24f)
            curveTo(105.05f, 46.03f, 102.93f, 51.1f, 97.14f, 56.89f)
            curveTo(104.11f, 62.2f, 106.0f, 68.22f, 106.0f, 76.72f)
            curveTo(106.0f, 92.18f, 101.16f, 102.69f, 82.27f, 102.69f)
            curveTo(63.39f, 102.69f, 58.55f, 92.18f, 58.55f, 76.72f)
            close()
            moveTo(82.27f, 64.68f)
            curveTo(78.02f, 64.68f, 76.96f, 67.63f, 76.96f, 75.66f)
            curveTo(76.96f, 83.8f, 78.02f, 86.63f, 82.27f, 86.63f)
            curveTo(86.52f, 86.63f, 87.58f, 83.8f, 87.58f, 75.66f)
            curveTo(87.58f, 67.63f, 86.52f, 64.68f, 82.27f, 64.68f)
            close()
            moveTo(82.27f, 30.68f)
            curveTo(78.38f, 30.68f, 77.43f, 32.57f, 77.43f, 40.72f)
            curveTo(77.43f, 48.86f, 78.38f, 50.75f, 82.27f, 50.75f)
            curveTo(86.16f, 50.75f, 87.11f, 48.86f, 87.11f, 40.72f)
            curveTo(87.11f, 32.57f, 86.16f, 30.68f, 82.27f, 30.68f)
            close()
        }
        path(
        ...
        path(
            ...
            curveTo(55.19f, 125.38f, 55.6f, 127.06f, 55.6f, 129.47f)
            curveTo(55.6f, 132.29f, 55.19f, 133.96f, 53.59f, 133.96f)
        ...
        path(
            ...
            moveTo(60.73f, 128.53f)
            verticalLineTo(128.12f)
            curveTo(60.73f, 127.47f, 60.93f, 125.26f, 62.73f, 125.26f)
            curveTo(64.25f, 125.26f, 64.64f, 126.71f, 64.64f, 127.93f)
            verticalLineTo(128.53f)
            ...
            curveTo(65.66f, 135.44f, 66.35f, 132.72f, 66.35f, 131.55f)
            horizontalLineTo(64.64f)
            curveTo(64.64f, 132.37f, 64.41f, 134.09f, 62.77f, 134.09f)
        ...
        path(
            ...
            moveTo(71.71f, 125.38f)
            curveTo(73.55f, 125.38f, 73.91f, 127.54f, 73.91f, 129.67f)
            curveTo(73.91f, 131.92f, 73.55f, 133.68f, 71.69f, 133.68f)
            curveTo(69.97f, 133.68f, 69.7f, 131.45f, 69.7f, 129.67f)
            curveTo(69.7f, 127.06f, 70.11f, 125.38f, 71.71f, 125.38f)
            close()
            moveTo(75.53f, 124.19f)
            horizontalLineTo(73.9f)
            ...
            horizontalLineTo(73.82f)
            verticalLineTo(135.11f)
            curveTo(73.82f, 135.87f, 73.9f, 137.56f, 71.68f, 137.56f)
            curveTo(70.79f, 137.56f, 70.01f, 137.17f, 69.93f, 136.18f)
            horizontalLineTo(68.21f)
            curveTo(68.5f, 138.91f, 71.13f, 138.91f, 71.8f, 138.91f)
        ...
        path(
            ...
            curveTo(102.73f, 122.15f, 103.09f, 121.86f, 103.83f, 121.86f)
