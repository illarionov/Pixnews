...
import ru.pixnews.gradle.project.testing.graalvm.GraalvmCompilerJvmArgumentsProvider
import ru.pixnews.gradle.project.testing.graalvm.isRunningOnGraalVm
