...
import ru.pixnews.feature.calendar.testing.element.util.havingAchestor
...
public class DateSelectionHeaderElement(
    ...
    public val yearMonthPickerMatcher: SemanticsMatcher =
        hasTestTag("calendar:header:year_month_picker_button")
    public val weekDaysRootMatcher: SemanticsMatcher = hasTestTag("calendar:header:week_days_row")
