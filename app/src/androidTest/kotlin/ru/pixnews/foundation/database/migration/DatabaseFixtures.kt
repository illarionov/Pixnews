...
// TODO: read from setup.sql
object DatabaseFixtures {
    val populateGameModeRequest = listOf(
        """
    ...
    val populatePlatformRequests = listOf(
        """
    ...
    val populatePlayerPerspectiveRequests = listOf(
        """
    ...
    fun SupportSQLiteDatabase.prePopulateDatabase() {
        this.beginTransaction()
        try {
            listOf(
                populateGameModeRequest,
                populatePlatformRequests,
                populatePlayerPerspectiveRequests,
            ).flatten().forEach {
                execSQL(it)
            }
