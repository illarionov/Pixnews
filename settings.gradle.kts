...
buildscript {
    ...
    dependencies {
        ...
        classpath("org.jetbrains.kotlin:compose-compiler-gradle-plugin:2.0.0-RC3")
        classpath("org.jetbrains.kotlin:kotlin-gradle-plugin:2.0.0-RC3")
        classpath("com.google.devtools.ksp:symbol-processing-gradle-plugin:2.0.0-RC3-1.0.20")
