...
import ru.pixnews.gradle.UnpackAarClassesTransform
...
fun createComposeRuntimeCompileClasspath(): FileCollection {
    ...
    dependencies {
        add(compileClasspathAarConfiguration.name, platform(versionCatalog.findLibrary("androidx-compose-bom").get()))
