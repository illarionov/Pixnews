...
@file:Suppress("MagicNumber", "FLOAT_IN_ACCURATE_CALCULATIONS", "LOCAL_VARIABLE_EARLY_DECLARATION")
...
public fun Modifier.placeholder(
    ...
    val activeColor = if (color.isSpecified) color else PlaceholderDefaults.color()
    val activeShape = shape ?: MaterialTheme.shapes.small
    val paint = remember { Paint() }
    remember(activeColor, activeShape, highlight) {
        drawWithContent {
