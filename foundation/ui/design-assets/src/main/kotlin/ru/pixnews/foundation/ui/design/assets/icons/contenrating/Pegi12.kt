...
internal val Pegi12: ImageVector
    get() = cache ?: ImageVector.Builder(
        ...
        path(
            ...
            moveTo(104.35f, 83.8f)
            verticalLineTo(101.27f)
            horizontalLineTo(59.25f)
            verticalLineTo(82.97f)
            curveTo(79.79f, 55.0f, 86.4f, 50.28f, 86.4f, 39.54f)
            curveTo(86.4f, 35.17f, 84.75f, 32.57f, 81.56f, 32.57f)
            curveTo(77.2f, 32.57f, 76.25f, 35.99f, 76.25f, 39.89f)
            verticalLineTo(44.96f)
            horizontalLineTo(59.02f)
            verticalLineTo(39.3f)
            curveTo(59.02f, 25.96f, 65.51f, 15.1f, 81.56f, 15.1f)
            curveTo(96.91f, 15.1f, 105.29f, 24.78f, 105.29f, 40.24f)
            curveTo(105.29f, 58.66f, 89.71f, 70.7f, 79.08f, 83.8f)
            horizontalLineTo(104.35f)
            close()
        }
        path(
        ...
        path(
            ...
            curveTo(56.66f, 135.44f, 57.4f, 131.96f, 57.4f, 129.47f)
            curveTo(57.4f, 126.22f, 56.41f, 123.91f, 53.82f, 123.91f)
            curveTo(52.63f, 123.91f, 51.67f, 124.73f, 51.45f, 125.54f)
        ...
        path(
            ...
            curveTo(68.5f, 138.91f, 71.14f, 138.91f, 71.81f, 138.91f)
            curveTo(74.02f, 138.91f, 75.53f, 137.73f, 75.53f, 134.46f)
            verticalLineTo(124.19f)
            close()
        }
        path(
        ...
        path(
            ...
            curveTo(94.3f, 123.91f, 93.16f, 124.48f, 92.71f, 125.49f)
