...
internal val Pegi16: ImageVector
    get() = cache ?: ImageVector.Builder(
        ...
        path(
            fill = SolidColor(Color(0xfff5a200)),
            fillAlpha = 1.0f,
            stroke = null,
            strokeAlpha = 1f,
            strokeLineWidth = 1f,
        ...
        path(
            ...
            moveTo(77.67f, 52.4f)
            curveTo(81.21f, 49.09f, 83.81f, 46.73f, 89.71f, 46.73f)
            curveTo(100.68f, 46.73f, 106.47f, 56.06f, 106.47f, 73.41f)
            curveTo(106.47f, 89.7f, 102.22f, 102.69f, 82.74f, 102.69f)
            curveTo(69.05f, 102.69f, 62.08f, 95.72f, 59.61f, 82.5f)
            curveTo(58.54f, 76.72f, 58.42f, 69.63f, 58.42f, 59.96f)
            curveTo(58.54f, 48.15f, 58.66f, 41.07f, 59.73f, 35.28f)
            curveTo(62.2f, 22.06f, 69.17f, 15.1f, 82.86f, 15.1f)
            curveTo(95.25f, 15.1f, 105.29f, 22.77f, 105.29f, 35.76f)
            verticalLineTo(40.13f)
            horizontalLineTo(88.05f)
            verticalLineTo(38.12f)
            curveTo(88.05f, 32.22f, 85.81f, 30.68f, 82.86f, 30.68f)
            curveTo(79.32f, 31.15f, 77.78f, 34.46f, 77.67f, 39.18f)
            verticalLineTo(52.4f)
            horizontalLineTo(77.67f)
            close()
            moveTo(82.98f, 63.73f)
            curveTo(79.32f, 63.73f, 77.67f, 67.39f, 77.67f, 75.18f)
            curveTo(77.67f, 83.09f, 79.32f, 86.63f, 82.98f, 86.63f)
            curveTo(86.87f, 86.63f, 88.53f, 83.09f, 88.53f, 75.18f)
            curveTo(88.53f, 67.39f, 86.87f, 63.73f, 82.98f, 63.73f)
            close()
        }
        path(
        ...
        path(
            ...
            curveTo(51.91f, 134.84f, 52.83f, 135.44f, 53.81f, 135.44f)
            curveTo(56.66f, 135.44f, 57.39f, 131.96f, 57.39f, 129.47f)
            curveTo(57.39f, 126.22f, 56.41f, 123.91f, 53.81f, 123.91f)
        ...
        path(
            ...
            curveTo(64.24f, 125.26f, 64.63f, 126.71f, 64.63f, 127.93f)
            ...
            curveTo(64.63f, 132.37f, 64.4f, 134.09f, 62.77f, 134.09f)
        ...
        path(
            ...
            curveTo(70.79f, 137.56f, 70.0f, 137.17f, 69.93f, 136.18f)
        ...
        path(
            ...
            moveTo(77.88f, 135.15f)
            horizontalLineTo(79.6f)
            verticalLineTo(124.19f)
            horizontalLineTo(77.88f)
            verticalLineTo(135.15f)
            close()
            moveTo(77.88f, 122.52f)
            horizontalLineTo(79.6f)
        ...
        path(
            ...
            moveTo(105.25f, 129.67f)
            curveTo(105.25f, 132.76f, 106.04f, 135.44f, 109.2f, 135.44f)
            curveTo(112.35f, 135.44f, 113.14f, 132.76f, 113.14f, 129.67f)
            curveTo(113.14f, 126.58f, 112.37f, 123.91f, 109.2f, 123.91f)
            curveTo(106.06f, 123.91f, 105.25f, 126.58f, 105.25f, 129.67f)
            close()
