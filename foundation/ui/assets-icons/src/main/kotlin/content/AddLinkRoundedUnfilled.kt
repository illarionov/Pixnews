...
internal val AddLinkRoundedUnfilled400w0g24dp: ImageVector
    get() = cache ?: ImageVector.Builder(
        name = "AddLinkRoundedUnfilled400w0g24dp",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        quadTo(703.0f, 800.0f, 691.5f, 788.5f)
        quadTo(680.0f, 777.0f, 680.0f, 760.0f)
        lineTo(680.0f, 680.0f)
        lineTo(600.0f, 680.0f)
        quadTo(583.0f, 680.0f, 571.5f, 668.5f)
        quadTo(560.0f, 657.0f, 560.0f, 640.0f)
        quadTo(560.0f, 623.0f, 571.5f, 611.5f)
        quadTo(583.0f, 600.0f, 600.0f, 600.0f)
        lineTo(680.0f, 600.0f)
        lineTo(680.0f, 520.0f)
        quadTo(680.0f, 503.0f, 691.5f, 491.5f)
        quadTo(703.0f, 480.0f, 720.0f, 480.0f)
        quadTo(737.0f, 480.0f, 748.5f, 491.5f)
        quadTo(760.0f, 503.0f, 760.0f, 520.0f)
        ...
        quadTo(760.0f, 777.0f, 748.5f, 788.5f)
        quadTo(737.0f, 800.0f, 720.0f, 800.0f)
        close()
    }.build().also { cache = it }
